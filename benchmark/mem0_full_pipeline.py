...
def run_command(cmd: list, description: str, log_file: str = None):
    ...
    # Ensure environment variables (like CUDA_VISIBLE_DEVICES) are inherited
    env = os.environ.copy()
...
def main():
    ...
    # Extend index_cmd with graph flags
    index_cmd.extend(graph_flags)
    ...
    # Extend retrieve_cmd with graph flags
    if args.graph_provider:
        retrieve_cmd.extend(graph_flags)
