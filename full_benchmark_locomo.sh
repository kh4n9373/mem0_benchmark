#!/bin/bash
# =============================================================================
# LOCOMO Full Benchmark - Automated Execution with UV
# =============================================================================

set -e

# Force use GPU 1 (avoid GPU 0 if busy)
...
DATASET_PATH="$SCRIPT_DIR/data/processed_data/locomo_processed_data.json"  # Auto-relative
